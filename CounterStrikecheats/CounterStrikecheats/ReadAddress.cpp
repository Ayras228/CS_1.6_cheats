...
void ReadAddress<GameType>::search_address(HANDLE csProcess, std::uint8_t* current_ptr, GameType value, MEMORY_BASIC_INFORMATION& m_i)
{
...
template<typename GameType>
void ReadAddress<GameType>::scan_memory(HANDLE csProcess, std::uint32_t read_address, GameType value)
{
